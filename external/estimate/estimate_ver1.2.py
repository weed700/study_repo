...
form_class2 = uic.loadUiType("s_window.ui")[0]
...
class MyWindow(QMainWindow, form_class):
    ...
    def setUI(self):
        ...
        self.manager_add.clicked.connect(self.Manager_E_Add) # 매니저 추가 버튼 
    ...
    # 새로운 매니저 명함 추가 버튼 이벤트
    def Manager_E_Add(self):
        self.second=Est_Manager()
